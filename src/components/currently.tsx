      ...
      <div className="container mx-auto px-6">
        ...
        >
          <div className="md:w-1/3">
            ...
            <p className="text-sm text-foreground/90 mt-2 font-light">What I'm focused on right now.</p>
          </div>
          
          <div className="md:w-2/3 border-l border-border-subtle pl-8 space-y-4">
            <div className="flex items-center gap-4 group">
              <span className="text-accent font-mono">{'>'}</span>
              <span className="text-foreground/90 group-hover:text-foreground transition-colors font-light">
                Building production-grade backend architectures<span className="animate-pulse text-accent font-bold">_</span>
              </span>
            </div>
            <div className="flex items-center gap-4 group">
              <span className="text-accent font-mono">{'>'}</span>
              <span className="text-foreground/90 group-hover:text-foreground transition-colors font-light">Solving complex DSA problems daily</span>
            </div>
            <div className="flex items-center gap-4 group">
              <span className="text-accent font-mono">{'>'}</span>
              <span className="text-foreground/90 group-hover:text-foreground transition-colors font-light">Exploring scalable AI/ML deployments</span>
            </div>
            <div className="flex items-center gap-4 group">
              <span className="text-accent font-mono">{'>'}</span>

          ...
          {profile.achievements.map((item, index) => (
            ...
            >
              <div className="md:w-1/4 mb-4 md:mb-0 shrink-0">
                <div className="text-xs font-mono tracking-[0.2em] text-foreground-muted uppercase">
              ...
              <div className="md:w-3/4 md:pl-12">
                ...
                <p className="text-foreground-secondary leading-relaxed max-w-2xl font-light">
                  {item.description}
                </p>
              </div>
            </motion.div>
